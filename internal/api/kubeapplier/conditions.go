...
const (
	...
	// ConditionReasonWaitingForDeletion is set on an ApplyDesire with Type=Delete when
	// the target item still exists in the cluster, either because finalizers are
	// running or the delete call has just been issued.

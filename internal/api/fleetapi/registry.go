...
var (
	...
	ControlPlaneVersionRolloutControllerResourceType = azcorearm.NewResourceType(coreapi.ProviderNamespace, ControlPlaneVersionRolloutResourceTypeName+"/"+ControllerResourceTypeName)
)

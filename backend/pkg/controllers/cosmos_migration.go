...
// migrateClusterDesires migrates kube-applier desire types (ApplyDesire (including Type=Delete),
...
// migrateNodePoolDesires migrates kube-applier desire types (ApplyDesire (including Type=Delete),
